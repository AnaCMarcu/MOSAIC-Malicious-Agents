        ...
        tables = {
            ...
            'posts': '''
                CREATE TABLE IF NOT EXISTS posts (
                    ...
                    num_shares_m INTEGER DEFAULT 0,
                    num_flags INTEGER DEFAULT 0,
                    num_flags_m INTEGER DEFAULT 0,
            ...
            'spread_metrics': '''
                CREATE TABLE IF NOT EXISTS spread_metrics (
                    ...
                    views_m INTEGER NOT NULL,
                    diffusion_depth INTEGER NOT NULL,
                    num_likes INTEGER NOT NULL,
                    num_likes_m INTEGER NOT NULL,
                    num_shares INTEGER NOT NULL,
                    num_shares_m INTEGER NOT NULL,
                    num_flags INTEGER NOT NULL,
                    num_flags_m INTEGER NOT NULL,
                    num_comments INTEGER NOT NULL,
                    num_comments_m INTEGER NOT NULL,
                    num_notes INTEGER NOT NULL,
                    num_note_ratings INTEGER NOT NULL,
                    total_interactions INTEGER NOT NULL,
                    total_interactions_m INTEGER NOT NULL,
